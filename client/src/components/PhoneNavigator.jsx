...
function PhoneNavigator() {
  return (
    <div className="sm:hidden sticky  z-50 bottom-0 ">
        ...
        <div className="w-screen flex flex-row justify-center">
          <NavLink
            ...
            className={({ isActive }) =>
              `${
                isActive
                  ? "bg-bottomWhite rounded-full w-1/5 flex flex-col py-4 my-1 m-auto"
                  : "bg-white w-1/5 flex flex-col py-4 m-auto my-1"
              }`
            }
          >
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `${
                isActive
                  ? "bg-bottomWhite rounded-full w-1/5 flex flex-col py-4 my-1 m-auto"
                  : "bg-white w-1/5 flex flex-col py-4 my-1 m-auto"
              }`
            }
          >
